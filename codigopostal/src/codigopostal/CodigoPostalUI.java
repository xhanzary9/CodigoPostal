...
public class CodigoPostalUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CodigoPostalUI
     */
    ...
    private String FORMATO_MEX_MSG = "El formato del código postal en México es 5 dígitos sin espacios: #####";
    private String FORMATO_US_MSG = "El formato del código postal en los Estados Unidos es 5 dígitos sin espacios: #####";
    private String FORMATO_CAN_MSG = "El formato del código postal en Cánada es la forma A#A  #A# donde A es una letra y # un número.";
    private String FORMATO_JAP_MSG = "Los códigos Postales en Japón consisten de 7 dígitos con un guión después del tercer dígito: XXX-XXXX";
    private String FORMATO_CHI_MSG = "Los códigos postales de China constan de seis dígitos: XXXXX";
}
